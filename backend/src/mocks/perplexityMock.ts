...
const DEFAULT_COMPETITORS = [
  {
    ...
    reason: 'Dominant player in the same vertical with overlapping ad strategy',
  },
  {
    name: 'Challenger Brand B',
    reason: 'Aggressively targeting the same audience segments on Meta',
  },
  { name: 'Niche Competitor C', reason: 'Strong overlap in product category and pricing tier' },
  {
    name: 'Emerging Rival D',
    reason: 'Fast-growing brand with similar positioning and creative style',
  },
  {
    name: 'Legacy Brand E',
    reason: 'Established competitor with high brand recall in the same market',
  },
]

export async function mockFindCompetitors(
  brandName: string,
